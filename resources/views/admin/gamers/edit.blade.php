    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="col-lg-12  col-md-12 ">
            ...
            <div class="card mb-4 shadow-1">
                <div class="card-body ">
                    <form action="{{ route('gamers.update',[$item->id]) }} " method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-row">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" value="{{ old('surname',$item->surname) }}" class="form-control"
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" value="{{ old('age',$item->age) }}" class="form-control"
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" value="{{ old('weight',$item?->weight) }}" class="form-control"
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" value="{{ old('height',$item->height) }}" class="form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="custom-select col-md-12" name="position_id" id="position_id">
                                    ...
                                    @foreach($positions as $position)
                                        <option
                                            value="{{ $position->id }}" @selected($position->id == old('position_id',$item->position_id))> {{$position->name}} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
