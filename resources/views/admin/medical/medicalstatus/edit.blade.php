    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="col-lg-10 col-xlg-9 col-md-7  ">
            <div class="card">
                ...
                <form class="form-horizontal " action="{{ route('medical.statuses.update',[$item->id])}}" method="post" >
                    @csrf
                    @method('put')
                        ...
                        <div class="tab-pane fade active show" id="my-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  name="name[ru]" class="form-control" value="{{ $item->name['ru'] }}"  id="name[ru]">
